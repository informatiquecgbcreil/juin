...
DEFAULT_PERMS: list[tuple[str, str]] = [
    ...
    ("gouvernance:view", "Voir la vie associative (instances, mandats, réunions)"),
    ("gouvernance:edit", "Gérer les instances, mandats, réunions et émargements"),
...
PERM_ALIAS_MASQUES_UI: dict[str, str] = {
    ...
    "participants:write": "participants:edit",
    "participant:edit": "participants:edit",
    "bilan:view": "bilans:view",
...
ROLE_TEMPLATES: dict[str, dict[str, Iterable[str]]] = {
    ...
    "responsable_secteur": {
        "perms": [
            ...
            "gouvernance:view", "gouvernance:edit",
...
PERMS_AUTO_GRANT = {
    ...
    "gouvernance:view": ("direction", "directrice", "finance", "responsable_secteur", "admin_tech"),
    "gouvernance:edit": ("direction", "directrice", "responsable_secteur"),
}
...
def _category_from_code(code: str) -> str:
    ...
    mapping = {
        "dashboard": "Accueil et navigation",
        "secteurs": "Secteurs et portée",
        "scope": "Secteurs et portée",
